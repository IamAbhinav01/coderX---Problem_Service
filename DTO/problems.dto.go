...
type CodeSnippet struct {
	Language     string `bson:"language" json:"language" validate:"required,oneof=python java cpp Python Java CPP"`
...
type GenerateProblem struct {
	...
	Difficulty   string        `bson:"difficulty" json:"difficulty" validate:"required,oneof=easy medium hard"`
